...
import { addInteraction } from '@/services/leadServices';
...
const props = defineProps(['leadDetails']);
...
const onSubmit = handleSubmit(async (values) => {
  try {
    await addInteraction(props.leadDetails.id, { ...values, date: new Date(values.date)});
    toast({
      title: 'Success',
